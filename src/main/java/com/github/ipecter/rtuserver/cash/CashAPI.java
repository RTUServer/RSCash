...
public class CashAPI {
    ...
    public static boolean addCash(UUID uuid, String cash, int value) {
        ...
        int max = instance.getCashConfig().getMap().get(cash).getMaxCash();
    ...
    public static Integer getMaxCash(UUID uuid, String cash) {
        ...
        return RSCash.getInstance().getCashConfig().getMap().get(cash).getMaxCash();
    }
    ...
    public static boolean isExistCash(UUID uuid, String cash) {
        if (!RSCash.getInstance().getCashConfig().getMap().containsKey(cash)) {
